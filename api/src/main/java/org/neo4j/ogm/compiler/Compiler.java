...
public interface Compiler extends LoadableService {
	...
	/**
     * Whether the compiler has new nodes to create
     * @return true if there are new nodes to be created, false otherwise
     */
    boolean hasNewNodes();

	/**
     * Whether the compiler has updates/deletes to nodes or relationships
     * @return true if there are updates or deletes to nodes or relationships
     */
    boolean hasUpdates();
