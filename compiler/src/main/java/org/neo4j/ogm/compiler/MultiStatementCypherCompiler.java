...
public class MultiStatementCypherCompiler implements Compiler {
	...
	public boolean hasNewNodes() {
		return newNodeBuilders.size() > 0;
	}

	@Override
	public boolean hasUpdates() {
		return newRelationshipBuilders.size() > 0 || existingNodeBuilders.size() > 0 || existingRelationshipBuilders.size() > 0 || deletedRelationshipBuilders.size() > 0 || deletedRelationshipEntityBuilders.size() > 0;
	}
